...
<main class="form-signin w-100 m-auto">
  <form action="<%= request.getContextPath() %>/Login" method="post">
  	<img class="mb-4" src="https://media.tenor.com/QkBOcqjpksIAAAAM/patrick-star-to-do-list.gif" alt="" width="280" height="200" style="border-radius: 50%;">
    <h1 class="h3 mb-3 fw-normal">Agenda<br><br>Por favor, faça login!</h1>
    <br>
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" name="usuario" required>
      <label for="floatingInput">Login do usuario</label>
    </div>
    <div class="form-floating">
    ...
    <br>
    <br>
    Não tem Cadastro? <a href="/Atv_Pratica15_EnzoMb_DW1/registerUsuario" >Cadastrar</a>
  </form>
</main>
